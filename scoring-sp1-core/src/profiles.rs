//! Role-adaptive scoring profiles (no_std version).
...
pub fn list_profiles() -> alloc::vec::Vec<RoleProfile> {
    alloc::vec![engineering_profile(), marketing_profile(), non_technical_profile()]
}
